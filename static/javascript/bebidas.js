document.addEventListener("DOMContentLoaded", () => {
    ...
    // Realizo la solicitud fetch para obtener los productos activos
    fetch(`../../RosarioFiesta-back/public/get-product-activo.php?categoria=2`) 
        .then(response => response.json())
        .then(data => {
            if (data.success) {
                const products = data.productos; // Asigno los productos activos obtenidos desde PHP
